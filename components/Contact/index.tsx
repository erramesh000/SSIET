          ...
          <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
            ...
            >
              ...
              <div className="5 mb-7">
                ...
                <p>G.T. Road, near Dayanand Math Dinanagar, Dinanagar, Punjab 143531</p>
              </div>
              <div className="5 mb-7">
                <h3 className="mb-4 text-metatitle3 font-medium text-black dark:text-white">
                  Email Address
                ...
                <p>
                  <a href="mailto:directorssgi@gmail.com">directorssgi@gmail.com</a>
                </p>
              </div>
              <div>
                ...
                <p>
                  <a href="tel:+918558831009" >+91 8558831009</a>
                </p>
              </div>
            </motion.div>
          </div>
